...
exports.plugins = [
    (0, preset_adonis_1.assert)(),
    (0, preset_adonis_1.runFailedTests)(),
    (0, preset_adonis_1.apiClient)(),
];
exports.reporters = [(0, preset_adonis_1.specReporter)()];
exports.runnerHooks = {
    setup: [
        () => TestUtils_1.default.ace().loadCommands(),
        () => TestUtils_1.default.db().migrate(),
        () => TestUtils_1.default.db().seed(),
    ],
    teardown: [],
};
